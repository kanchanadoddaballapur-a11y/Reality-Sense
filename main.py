    ...
    if image_parts and not is_video_analysis:
        ...
        if calibrator:
            ...
            if raw_scores:
                ...
                # Passport photos and heavily edited real photos often score around 0.50 - 0.65.
                # We raise the AI threshold to 0.70 to force these ambiguous real photos into the 0-10% band.
                THRESHOLD = 0.70 
                ...
                if calibrated_prob < THRESHOLD:
                    ...
                    final_prob = 0.80 + ((calibrated_prob - THRESHOLD) / (0.85 - THRESHOLD)) * 0.10
                else:
                    # Squeeze into 0.90 - 0.99 band (Obvious AI)
                    final_prob = 0.90 + ((calibrated_prob - 0.85) / 0.15) * 0.09
